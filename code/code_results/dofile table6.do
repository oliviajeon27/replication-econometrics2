...
collapse (sum) facilityamt (first) year_month, by(borrowercompanyid packageid instTL) //aggregate in borrower x package x loan type (figure5: month x loan type) : within borrower comparison vs time series comparison
